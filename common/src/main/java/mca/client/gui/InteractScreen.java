...
import mca.network.c2s.GetInteractDataRequest;
import mca.network.c2s.InteractionCloseRequest;
import mca.network.c2s.InteractionDialogueInitMessage;
import mca.network.c2s.InteractionDialogueMessage;
