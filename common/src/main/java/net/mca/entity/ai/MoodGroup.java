...
public enum MoodGroup {
    ...
    GENERAL(
            new MoodBuilder("depressed")
                    .sounds(2, SoundsMCA.VILLAGER_MALE_CRY.get(), SoundsMCA.VILLAGER_FEMALE_CRY.get())
                    .particles(20, ParticleTypes.SPLASH)
                    .building("inn")
                    .color(Formatting.RED).build(),
            new MoodBuilder("sad")
                    .sounds(8, SoundsMCA.VILLAGER_MALE_CRY.get(), SoundsMCA.VILLAGER_FEMALE_CRY.get())
            ...
            new MoodBuilder("overjoyed")
                    .sounds(8, SoundsMCA.VILLAGER_MALE_LAUGH.get(), SoundsMCA.VILLAGER_FEMALE_LAUGH.get())
    ...
    PLAYFUL(
            ...
            new MoodBuilder("entertained")
                    .sounds(2, SoundsMCA.VILLAGER_MALE_LAUGH.get(), SoundsMCA.VILLAGER_FEMALE_LAUGH.get())
    ...
    SERIOUS(
            new MoodBuilder("infuriated")
                    .sounds(2, SoundsMCA.VILLAGER_MALE_ANGRY.get(), SoundsMCA.VILLAGER_FEMALE_ANGRY.get())
                    .particles(20, ParticleTypes.ANGRY_VILLAGER)
                    .color(Formatting.RED).build(),
            new MoodBuilder("angry")
                    .sounds(8, SoundsMCA.VILLAGER_MALE_ANGRY.get(), SoundsMCA.VILLAGER_FEMALE_ANGRY.get())
